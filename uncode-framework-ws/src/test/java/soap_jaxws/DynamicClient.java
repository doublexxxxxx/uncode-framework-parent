...
public class DynamicClient {
    ...
    public static void main(String[] args) {
        try {
            ...
            QName serviceName = new QName("http://soap_jaxws.ws.core.uncodeframework.com/", "HelloService");
            QName portName = new QName("http://soap_jaxws.ws.core.uncodeframework.com/", "HelloServicePort");
