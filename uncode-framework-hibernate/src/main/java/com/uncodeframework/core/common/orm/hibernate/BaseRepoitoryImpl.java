package com.uncodeframework.core.common.orm.hibernate;
...
import com.uncodeframework.core.common.entity.LogicDeleteable;
import com.uncodeframework.core.common.orm.BaseRepository;
import com.uncodeframework.core.common.orm.RepositoryHelper;
import com.uncodeframework.core.common.orm.search.Searchable;
import com.uncodeframework.core.common.orm.sql.SQL;
import com.uncodeframework.core.common.orm.sql.SQLContext;
...
public class BaseRepoitoryImpl<T extends AbstractEntity<ID>, ID extends Serializable> implements BaseRepository<T, ID> {
	...
	public Session getSession() {
		...
		return sessionFactory.getCurrentSession(); //sessionFactory.openSession();//sessionFactory.getCurrentSession();
	}
