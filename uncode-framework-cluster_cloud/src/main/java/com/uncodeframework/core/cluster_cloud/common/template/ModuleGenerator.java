package com.uncodeframework.core.cluster_cloud.common.template;
...
import com.uncodeframework.core.cluster_cloud.common.data.DataMng;
import com.uncodeframework.core.cluster_cloud.common.data.Table;
...
public class ModuleGenerator extends AbstractSpringJunitTest {
	...
	public static final String package_name = "com.uncodeframework.core.cluster_cloud";
	
	public static final String entity_p = package_name + ".core.bean";
	public static final String query_p = package_name + ".core.query";
	public static final String entity_xml_p = "ibatis";
	public static final String sqlmap_config_xml = "";

	public static final String action_p = package_name + ".core.action";
	public static final String dao_p = package_name + ".core.dao";
	public static final String dao_impl_p = package_name + ".core.dao.impl";
	public static final String service_p = package_name + ".core.service";
	public static final String service_impl_p = package_name + ".core.service.impl";

	public static final String template_dir = package_name + ".common.template";
	...
	public static final String hash_function_p = package_name + ".core.dao.router";
...
//		index(tpl, f);
		// f = new File(getFilePath((String)
		// data.get("dao_impl_p"),data.get("Entity") + "DaoImpl.java"));
		// tpl = converString((String) data.get("template_dir")) + SPT +
		// dao_impl_tpl;
		// index(tpl,f);
	}
	...
	public void index(String tpl, File f) throws TemplateException, IOException {
		...
		try {
			...
			String path = ModuleGenerator.class.getResource("/").getPath();
			// FileWriter不能指定编码确实是个问题，只能用这个代替了。
			path = "/C:/MMM/PROJECT/UNCODESPACES/uncode-framework-parent/uncode-framework-cluster_cloud/target/classes/";
	...
	private String getResourcesFilePath(String packageName, String name) {
		String path = converString(packageName);
		return "src/main/resources/" + path + "/" + name;
	}
	...
	public void start() throws TemplateException, IOException {
		...
		// sqlmap-config
//		f = new File(getResourcesFilePath(sqlmap_config_xml, "sqlmap-config.xml"));
//		tpl = converString(template_dir) + SPT + sqlmap_config_tpl;
//		index(tpl, f);
//		// sharding_rules_on_namespace
//		f = new File(getResourcesFilePath(sharding_rules_on_namespace_p, "sharding-rules-on-namespace.xml"));
//		tpl = converString(template_dir) + SPT + sharding_rules_on_namespace_tpl;
//		index(tpl, f);
//		// hash_function
//		f = new File(getResourcesFilePath(hash_function_p, "HashFunction.java"));
