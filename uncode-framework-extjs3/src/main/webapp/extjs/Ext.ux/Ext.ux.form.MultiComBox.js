Ext.ns('Ext.ux.form');
Ext.ux.form.MultiComBox = Ext.extend(Ext.form.ComboBox, {
	splitSign : ',',
	selections : [],
	checks : [],
	hiddenValue : '',
	...
	initList : function() {
		...
		this.tpl = '<tpl for="."><div class="' + cls + '-item"><table border="0" width=80% height="16px" style="height:18px;"><tr >'
				+ '<td class="check-box" style="width:20px;height:18px;"></td><td style="font-size:12px;">{' + this.displayField
				+ '}</td></tr></table></div></tpl>';
		Ext.ux.form.MultiComBox.superclass.initList.call(this);
	...
	getValue : function() {
		return Ext.ux.form.MultiComBox.superclass.getValue.call(this);
	},
...
Ext.reg('multiCombox', Ext.ux.form.MultiComBox);
/*
 ...
 * 
 * var test = new Ext.ux.form.MultiComBox( { store : store1, displayField :
 * 'name', valueField : 'value', // typeAhead : true, triggerAction : 'all',
 * mode : 'local', emptyText : '请选择...', selectOnFocus : true, loadingText :
